...
public class ManageRepCommand implements TabExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        int newReputation = label.equals("repadd")
                ? WizardStoneCraft.getInstance().reputation.getOrDefault(targetId, WizardStoneCraft.getInstance().loadPlayerReputation(targetId)) + amount
                : WizardStoneCraft.getInstance().reputation.getOrDefault(targetId, WizardStoneCraft.getInstance().loadPlayerReputation(targetId)) - amount;
        ...
        WizardStoneCraft.getInstance().savePlayerReputation(targetId, newReputation);
